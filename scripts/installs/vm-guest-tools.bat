...
if not exist "C:\Windows\Temp\windows.iso" (
    ...
    cmd /c ""C:\Program Files\7-Zip\7z.exe" x -y C:\Windows\Temp\vmware-tools.tar -oC:\Windows\Temp"
...
cmd /c ""C:\Program Files\7-Zip\7z.exe" x -y C:\Windows\Temp\VBoxGuestAdditions.iso -oC:\Windows\Temp\virtualbox"
...
if exist "C:\Users\vagrant\prl-tools-win.iso" (
	...
	cmd /C "C:\Program Files\7-Zip\7z.exe" x -y C:\Windows\Temp\prl-tools-win.iso -oC:\Windows\Temp\parallels
